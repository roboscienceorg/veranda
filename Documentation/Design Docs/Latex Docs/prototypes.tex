...
\subsection{Deliverable}
Deliverables for this sprint included completion of the robot designer, image loading, and our third client presentation.
...
\begin{itemize}
	...
	\item Established JSON file format and begun work on load / save
\end{itemize} 
...
In this sprint we successfully named our product, which until this point was being referred to as something akin to "2D Robot Simulator". We named it the "RoboScience Simulator" which was chosen to match the website and online course being crafted by the client. 
