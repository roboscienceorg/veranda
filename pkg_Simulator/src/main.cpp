...
int main(int argc, char** argv)
{
    ...
    *************************************/
    ...
    qInfo() << "Searching" << QCoreApplication::applicationDirPath() + "/../../bin" << "for plugins";
    QDirIterator dir(QCoreApplication::applicationDirPath() + "/../../bin", {"*.so", "*.dll"}, QDir::Files, QDirIterator::Subdirectories);
    while(dir.hasNext())
    {
        dir.next();
