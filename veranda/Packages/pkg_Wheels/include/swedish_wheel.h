 ...
 */
class Swedish_Wheel : public WorldObjectComponent
{
    Q_OBJECT
...
public:
     ...
     */
    Swedish_Wheel(QObject* parent=nullptr);
     ...
     * \return "org.roboscience.veranda.worldObjectComponent.defaults.swedishwheel"
     */
    QString getPluginName() override { return SWEDISHWHEEL_IID; }
