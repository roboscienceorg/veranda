...
class DefaultRobotLoader : public WorldLoader_If
{
     ...
     */
    WorldObject* makeDiffDriveBot(QMap<QString, WorldObjectComponent_Factory_If*> plugins);
     ...
     */
    WorldObject* makeAckermannBot(QMap<QString, WorldObjectComponent_Factory_If*> plugins);
};
