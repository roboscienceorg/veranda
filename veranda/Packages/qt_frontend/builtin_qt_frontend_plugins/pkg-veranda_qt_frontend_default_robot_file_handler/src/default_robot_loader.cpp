...
WorldObject* DefaultRobotLoader::makeDiffDriveBot(QMap<QString, WorldObjectComponent_Factory_If *> plugins)
{
    QVector<WorldObjectComponent*> components;

    if(plugins.contains("org.roboscience.veranda.worldObjectComponent.defaults.touchring"))
    {
        WorldObjectComponent* touchRing = plugins["org.roboscience.veranda.worldObjectComponent.defaults.touchring"]->createComponent();
    ...
    if(plugins.contains("org.roboscience.veranda.worldObjectComponent.defaults.fixedwheel"))
    {
        WorldObjectComponent* leftWheel = plugins["org.roboscience.veranda.worldObjectComponent.defaults.fixedwheel"]->createComponent();
        WorldObjectComponent* rightWheel = plugins["org.roboscience.veranda.worldObjectComponent.defaults.fixedwheel"]->createComponent();
    ...
    if(plugins.contains("org.roboscience.veranda.worldObjectComponent.defaults.circle"))
    {
        WorldObjectComponent* circle = plugins["org.roboscience.veranda.worldObjectComponent.defaults.circle"]->createComponent();
    ...
    if(plugins.contains("org.roboscience.veranda.worldObjectComponent.defaults.lidar"))
    {
        WorldObjectComponent* lidar1 = plugins["org.roboscience.veranda.worldObjectComponent.defaults.lidar"]->createComponent();
...
WorldObject* DefaultRobotLoader::makeAckermannBot(QMap<QString, WorldObjectComponent_Factory_If *> plugins)
{
    QVector<WorldObjectComponent*> components;

    if(plugins.contains("org.roboscience.veranda.worldObjectComponent.defaults.lidar"))
    {
        WorldObjectComponent* lidar = plugins["org.roboscience.veranda.worldObjectComponent.defaults.lidar"]->createComponent();
    ...
    if(plugins.contains("org.roboscience.veranda.worldObjectComponent.defaults.rectangle"))
    {
        WorldObjectComponent* rectangle = plugins["org.roboscience.veranda.worldObjectComponent.defaults.rectangle"]->createComponent();
    ...
    if(plugins.contains("org.roboscience.veranda.worldObjectComponent.defaults.ackermann"))
    {
        WorldObjectComponent* steer = plugins["org.roboscience.veranda.worldObjectComponent.defaults.ackermann"]->createComponent();
