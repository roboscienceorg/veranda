...
public:
    ...
    virtual ~Ackermann_Steer() override {}
     ...
     * \return "org.roboscience.veranda.worldObjectComponent.defaults.ackermann"
     */
    QString getPluginName() override { return ACKERMANN_IID; }
