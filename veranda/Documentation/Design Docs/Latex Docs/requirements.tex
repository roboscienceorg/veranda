...
\subsection{User Story \#3\label{us:3}} 
...
\subsection{User Story \#7\label{us:7}} 
...
\subsubsection*{Status: Partially Fulfilled}
Due to time and framework constraints, unit tests were not written until very late in the project. Some of the core data structures (Property, Model) have unit tests associated with them.
